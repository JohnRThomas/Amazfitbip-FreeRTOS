...
BINARY		= main
SRCFILES	= uart_test.cpp io.c lcd_lpm013m126c.cpp freertos/heap_4.c freertos/list.c freertos/port.c freertos/queue.c freertos/tasks.c freertos/opencm3.c
